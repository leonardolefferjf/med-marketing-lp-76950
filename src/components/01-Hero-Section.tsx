...
export const HeroSection = () => {
  ...
  useEffect(() => {
    const preloadComponents = [
      () => import('@/components/02-Problems-Section'),
      () => import('@/components/03-Solucao-Apresentacao-Produto')
    ];
    ...
    <section className="bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-500 min-h-screen flex items-center px-4 py-20 relative">
      ...
      <div className="max-w-5xl mx-auto text-center mt-8">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-black leading-tight mb-6">
          <span className="bg-white px-2 py-1 rounded">Encha Sua Agenda</span> com <span className="bg-white px-2 py-1 rounded">162 Assistentes de IA</span> Trabalhando 24/7 por Você
        </h1>
        ...
        {/* Prova Social */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 mb-8 max-w-3xl mx-auto shadow-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">CFM Compliance</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-8">
          <button 
            ...
            className="inline-flex items-center gap-3 bg-black hover:bg-gray-900 text-white font-black text-xl px-12 py-6 rounded-xl transition-all duration-200 shadow-2xl hover:scale-105"
          >
          ...
          <button 
            onClick={scrollToOffer}
            className="block w-full md:inline-block bg-white hover:bg-gray-100 text-black font-bold text-lg px-8 py-4 rounded-xl transition-all duration-200 shadow-lg border-2 border-black"
          >
            Ver Como Funciona ⬇️
          </button>
        </div>
        ...
        <div className="bg-red-600 text-white rounded-xl p-6 max-w-md mx-auto shadow-2xl">
          ...
          <div className="bg-white rounded-full h-3 overflow-hidden">
            <div className="bg-red-800 h-full rounded-full animate-pulse" style={{ width: `${vagas}%` }}></div>
          </div>
