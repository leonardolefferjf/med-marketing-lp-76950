...
const medMarketingLP12Config: LandingPageConfig = {
  id: 'medmarketing-lp12',
  title: 'MedMarketingAI+ LP12 - IA para Marketing Médico',
  description: 'Plataforma completa de inteligência artificial para marketing médico - 165 assistentes + 12 módulos',
  slug: 'medmarketing-lp12',
...
export const MedMarketingLP12: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP12Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP12;
