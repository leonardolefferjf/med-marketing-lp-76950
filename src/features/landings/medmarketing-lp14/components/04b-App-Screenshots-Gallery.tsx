  ...
  const screenshots = [
    {
      ...
      description: '165 Assistentes IA via ChatGPT + Sistema de Recomendação',
      badge: 'Principal'
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {selectedImage !== null && (
          <div
            ...
            onClick={closeImage}
          >
            {/* Botão Fechar MELHORADO - Muito mais visível */}
            <button
              className="absolute top-4 right-4 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl transition-all z-50 shadow-2xl font-bold text-base flex items-center gap-2 border-2 border-white/30 hover:scale-105 active:scale-95"
              onClick={(e) => {
                e.stopPropagation();
                closeImage();
              }}
            ...
            {/* Dica de ajuda - aparece por 3 segundos */}
            <div className="absolute top-20 right-4 bg-gray-900/90 text-white px-4 py-2 rounded-lg text-sm z-50 border border-white/20 animate-pulse">
              💡 Clique aqui, fora da imagem ou pressione ESC
            </div>
