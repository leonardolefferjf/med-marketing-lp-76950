...
const medMarketingLP0Config: LandingPageConfig = {
  id: 'medmarketing-lp0',
  title: 'MedMarketingAI+ LP0 - IA para Marketing Médico',
  description: 'Plataforma de inteligência artificial para acelerar o marketing médico',
  slug: 'medmarketing-lp0',
  metaTitle: 'MedMarketingAI+ - Inteligência Artificial para Marketing Médico | 15 Assistentes IA',
...
export const MedMarketingLP0: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP0Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP0;
