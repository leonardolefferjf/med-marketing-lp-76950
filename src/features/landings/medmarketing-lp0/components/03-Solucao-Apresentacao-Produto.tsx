      ...
      <div className="max-w-6xl mx-auto">
              ...
              <tbody>
                ...
                <tr className="border-b bg-gray-50">
                  ...
                  <td className="p-4 text-center bg-yellow-50">
                    <div className="text-lg font-black text-green-600">R$ 497 único</div>
        ...
        <div className="text-center">
          <button 
            ...
            className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black font-black text-lg md:text-2xl py-6 px-12 rounded-2xl shadow-2xl transform hover:scale-105 transition-all inline-flex items-center gap-3"
          >
            <Sparkles className="w-6 h-6" />
            QUERO AUTOMAÇÃO COMPLETA AGORA
          </button>
