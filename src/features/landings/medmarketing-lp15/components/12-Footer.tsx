            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  O MedMarketingAI+ é uma ferramenta de auxílio ao marketing médico e fornece validação automática baseada na Resolução CFM 2.336/2023. A responsabilidade final pelo cumprimento das normas do CFM é do médico usuário. Todo conteúdo gerado deve ser revisado pelo profissional antes da publicação.
                </p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              <span className="font-bold text-white">Garantia de Cobertura:</span> A garantia de cobertura de processo CFM (até R$ 50k) aplica-se apenas a conteúdos gerados pela plataforma seguindo as recomendações do sistema de validação. Casos comprovados mediante análise da equipe jurídica parceira.
            </p>
          </div>
