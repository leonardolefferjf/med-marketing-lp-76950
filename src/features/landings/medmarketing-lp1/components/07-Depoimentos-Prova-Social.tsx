      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-black leading-tight mb-6">
            Mais de <span className="text-blue-600">500 médicos</span> já <span className="bg-yellow-300 px-2">transformaram</span> seu marketing
          </h2>
          
          <p className="text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Resultados reais de médicos que estão enchendo suas agendas com o MedMarketingAI+
          </p>
        </div>
        ...
        <p className="text-gray-600 text-sm mt-4">
          Encha sua agenda como estes médicos
        </p>
      </div>
    </section>
  );
