  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-white py-16 md:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-600">
            <div className="flex items-center gap-2">
              ...
              <span><strong className="text-gray-900">1.247</strong> médicos usando</span>
            </div>
        ...
        <div className="bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-500 text-black rounded-2xl p-6 md:p-10 mb-12 shadow-2xl">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-base md:text-xl leading-relaxed max-w-3xl">
              ...
              <strong>165 assistentes</strong> geram conteúdo ético, persuasivo e 100% CFM para encher sua agenda.
            </p>
          </div>
        </div>
        ...
        {/* Como Funciona - Mecanismo Único - OTIMIZADO */}
        <div className="bg-white rounded-2xl p-6 md:p-10 mb-12 shadow-xl border-2 border-gray-200">
          ...
          <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8 text-center max-w-3xl mx-auto">
            Diferente de ferramentas genéricas{' '}
            <span className="text-gray-400 line-through">(ChatGPT, Jasper, Copy.ai)</span>, 
            o MedMarketingAI+ foi{' '}
            <strong className="text-yellow-600">
              treinado exclusivamente para marketing médico brasileiro
            </strong>:
          </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-500 hover:scale-105 transition-transform">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    Cada assistente domina UMA tarefa específica: posts, stories, reels, campanhas, SEO, email, etc
                  </p>
                </div>
              </div>
            </div>
              ...
              <tbody>
                ...
                <tr className="border-b bg-gray-50 hover:bg-gray-100 transition-colors">
                  ...
                  <td className="p-3 md:p-4 text-center">
                    ...
                    <div className="text-xs text-gray-500">(+ sua expertise)</div>
                  </td>
                  <td className="p-3 md:p-4 text-center">
                ...
                <tr className="border-b bg-gray-50 hover:bg-gray-100 transition-colors">
                  ...
                  <td className="p-3 md:p-4 text-center bg-yellow-50">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span className="text-lg md:text-xl font-black text-yellow-600">30s</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr className="border-b hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-3 md:p-4 text-center text-xs md:text-sm text-gray-700">
                    Só quando usar
                  </td>
                  <td className="p-3 md:p-4 text-center text-xs md:text-sm text-gray-700">
                    Horário comercial
                  ...
                  <td className="p-3 md:p-4 text-center bg-green-50">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span className="text-lg md:text-xl font-black text-green-600">24/7</span>
                    </div>
                  </td>
                </tr>
              </tbody>
          ...
          <div className="mt-8 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-500">
            <div className="text-center">
              ...
              <p className="text-base md:text-lg text-gray-700">
                ChatGPT é <strong className="text-red-600">genérico</strong>. 
                Agências são <strong className="text-red-600">caras</strong>. 
                MedMarketingAI+ é <strong className="text-green-600">especializado, acessível e vitalício</strong>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-black to-gray-900 rounded-2xl p-8 md:p-12 text-center shadow-2xl border-4 border-yellow-500">
          ...
          <p className="text-base md:text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
            165 assistentes especializados + validação CFM + acesso vitalício por apenas R$ 997
          </p>
