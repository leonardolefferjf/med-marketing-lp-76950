      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight mb-6 px-4">
            O que dizem{' '}
            <span className="text-green-600">1.247 médicos</span>{' '}
            que já transformaram seu marketing
          </h2>
          
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto mb-6">
            Não acredite apenas em nossas palavras. Veja{' '}
            <strong className="text-gray-900">prints reais</strong> de médicos que já estão 
            usando o MedMarketingAI+ para encher suas agendas
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
            <div className="flex items-center gap-2 bg-green-50 px-4 py-2 rounded-full">
              ...
              <span className="text-gray-700 font-semibold">Depoimentos Verificados</span>
            </div>
            <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full">
              <Shield className="w-5 h-5 text-blue-600" />
              <span className="text-gray-700 font-semibold">100% Médicos Reais</span>
            </div>
            <div className="flex items-center gap-2 bg-purple-50 px-4 py-2 rounded-full">
              <Award className="w-5 h-5 text-purple-600" />
              <span className="text-gray-700 font-semibold">Resultados Comprovados</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 mb-12 shadow-xl border-2 border-gray-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
            <div className="bg-green-50 rounded-xl p-4 hover:scale-105 transition-transform">
              <Users className="w-8 h-8 text-green-600 mx-auto mb-2" />
              <div className="text-3xl md:text-4xl font-black text-gray-900">1.247</div>
              <div className="text-xs md:text-sm text-gray-600 font-semibold">Médicos ativos</div>
            </div>
        ...
        <div className="bg-gradient-to-br from-gray-100 to-gray-50 border-2 border-gray-300 rounded-2xl p-6 md:p-10 shadow-xl">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            <div className="bg-green-500 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg">
              ...
              Depoimento Verificado #{currentSlide + 1}
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 max-w-3xl mx-auto">
            ...
            <div>
              <p className="text-sm text-gray-700 leading-relaxed">
                <strong className="text-gray-900">Depoimentos reais e verificados.</strong> Todos os prints 
                são de médicos reais usando MedMarketingAI+. Resultados podem variar de acordo com a 
                especialidade médica, frequência de uso e estratégias aplicadas.
              </p>
            </div>
          </div>
        </div>
