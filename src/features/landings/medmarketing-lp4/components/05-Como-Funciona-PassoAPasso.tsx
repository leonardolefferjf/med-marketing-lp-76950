...
export default function HowItWorksSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtitle: 'Personalização para sua especialidade',
      ...
      items: [
        ...
        'Temas de interesse (preventivo, tratamento, etc)'
      ],
      result: 'Os 165 assistentes calibrados para sua especialidade e estilo',
      testimonial: {
        text: "3 minutos e a IA já entendeu perfeitamente meu estilo de comunicação",
        author: "Dr. Ricardo",
