...
const medMarketingLP3Config: LandingPageConfig = {
  id: 'medmarketing-lp3',
  title: 'MedMarketingAI+ LP3 - IA para Marketing Médico',
  description: 'Plataforma de inteligência artificial para acelerar o marketing médico - Versão 3',
  slug: 'medmarketing-lp3',
  metaTitle: 'MedMarketingAI+ LP3 - Inteligência Artificial para Marketing Médico | 162 Assistentes IA',
  metaDescription: 'Descubra o MedMarketingAI+: 162 assistentes de IA para marketing médico. Crie conteúdo profissional em minutos. Acesso vitalício por R$ 997.',
  keywords: [
...
export const MedMarketingLP3: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP3Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP3;
