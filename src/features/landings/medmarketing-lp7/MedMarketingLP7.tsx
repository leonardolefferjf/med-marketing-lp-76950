...
const medMarketingLP7Config: LandingPageConfig = {
  id: 'medmarketing-lp7',
  title: 'MedMarketingAI+ LP7 - IA para Marketing Médico',
  description: 'Plataforma completa de inteligência artificial para marketing médico - 165 assistentes + 12 módulos',
  slug: 'medmarketing-lp7',
...
export const MedMarketingLP7: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP7Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP7;
