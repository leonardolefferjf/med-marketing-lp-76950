...
export const HeroSection = () => {
  ...
  return <section className="bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-500 min-h-screen flex items-center px-4 py-20 relative">
      ...
      <div className="max-w-6xl mx-auto text-center mt-8">
        {/* Logo */}
        <div className="mb-6">
          <img src={mainImages.logoMedMarketing} alt="MedMarketingAI+ Logo" className="mx-auto h-20 w-auto" loading="eager" />
        </div>
        ...
        <p className="text-xl md:text-2xl lg:text-3xl text-black font-bold leading-relaxed mb-4 max-w-4xl mx-auto px-4">
          <span className="bg-white px-3 py-1 rounded-lg inline-block">
            Sem Cursos, Sem Agências, Sem Perder Tempo
          </span>
        </p>

        <p className="text-lg md:text-xl text-black/90 font-semibold mb-8 max-w-3xl mx-auto px-4">
          165 assistentes de IA que criam conteúdo enquanto você atende pacientes
        </p>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 md:p-6 mb-8 max-w-4xl mx-auto shadow-2xl border-2 border-white/50">
          ...
          <div className="rounded-xl overflow-hidden shadow-xl">
            <video src={dashboardVideo} className="w-full h-auto" autoPlay loop muted playsInline />
          </div>
          <p className="text-sm text-gray-700 text-center mt-3 font-semibold">
            ↑ Dashboard real com 165 assistentes IA organizados e prontos para usar
          </p>
        </div>

        {/* CTA Principal - OTIMIZADO */}
        <div className="mb-6">
          <button onClick={scrollToOffer} className="inline-flex items-center gap-3 bg-black hover:bg-gray-900 text-white font-black text-xl md:text-2xl px-10 md:px-16 py-5 md:py-7 rounded-2xl transition-all duration-200 shadow-2xl hover:scale-105 hover:shadow-3xl">
            GARANTIR ACESSO E COMEÇAR HOJE MESMO
        ...
        <button onClick={scrollToOffer} className="inline-flex items-center gap-2 bg-white/90 hover:bg-white text-black font-bold text-base md:text-lg px-8 py-4 rounded-xl transition-all duration-200 shadow-lg border-2 border-black/20 hover:border-black mb-8">
          Ver Como Funciona
        ...
        <div className="bg-red-600 text-white rounded-xl p-5 md:p-6 max-w-lg mx-auto shadow-2xl border-2 border-red-700">
          ...
          <div className="bg-white/20 rounded-full h-3 overflow-hidden mb-2">
            <div className="bg-white h-full rounded-full transition-all duration-500" style={{
            width: `${vagas}%`
          }}></div>
          </div>
