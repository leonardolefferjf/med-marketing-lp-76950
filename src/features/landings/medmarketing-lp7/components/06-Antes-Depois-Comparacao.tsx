        ...
        <div ref={sectionRef} className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-black rounded-2xl p-6 md:p-12 shadow-2xl">
          ...
          <div className="bg-black/10 rounded-xl p-6 text-center">
            <p className="text-base md:text-lg font-bold mb-2">
              📊 Com base na experiência da LefferTech impactando mais de 50 mil médicos globalmente
            </p>
            <p className="text-sm opacity-80">
              Esses são os resultados médios em 60-90 dias de uso do MedMarketingAI+.
