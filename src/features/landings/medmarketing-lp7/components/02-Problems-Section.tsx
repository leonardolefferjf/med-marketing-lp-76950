    ...
    <section className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white py-16 md:py-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto px-4 mb-6">
          ...
          {/* Pillar Message - NOVO */}
          <div className="bg-yellow-500 text-black px-6 py-4 rounded-xl max-w-2xl mx-auto font-black text-base md:text-lg text-center">
            ✓ Sem cursos de 40 horas • ✓ Sem agências de R$ 5k/mês • ✓ Sem perder fins de semana
          </div>
            ...
            <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
              ...
              <div className="flex-1 w-full">
                ...
                <p className="text-gray-300 text-base md:text-lg mb-4 leading-relaxed">
                  ...
                  {' '}E não, cursos de 40 horas não resolvem - você não tem esse tempo.
                </p>
