...
export default function HowItWorksSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Preenche um formulário rápido e o sistema te conhece:',
      items: [
        ...
        'Assistente Inteligente analisa seu perfil',
        'Recomenda automaticamente os melhores assistentes para você'
      ],
      result: 'Os 165 assistentes calibrados + recomendações personalizadas',
      testimonial: {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight mb-4 px-4">
            Acesso Exclusivo para Médicos em{' '}
            <span className="bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent">
              10 Minutos
            </span>
          </h2>
          <p className="text-xl md:text-2xl text-gray-700 font-bold mb-6">
            (Do cadastro aos primeiros posts)
          </p>

          <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto mb-4">
            Plataforma exclusiva para médicos • Validação automática do CRM
          </p>

          <div className="bg-blue-50 border-2 border-blue-500 rounded-xl p-4 max-w-2xl mx-auto mb-8">
            <div className="flex items-center gap-3">
              <Shield className="w-6 h-6 text-blue-600" />
              <div className="text-left">
                <div className="text-sm font-bold text-gray-900">Validação CRM em até 6 horas</div>
                <div className="text-xs text-gray-600">Garante que apenas médicos tenham acesso</div>
              </div>
            </div>
          </div>
