    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-900">
            <div className="flex items-center gap-2 bg-white/50 px-4 py-2 rounded-full backdrop-blur-sm">
              ...
              <span className="font-bold">Médicos de todo Brasil</span>
            </div>
            <div className="flex items-center gap-2 bg-white/50 px-4 py-2 rounded-full backdrop-blur-sm">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-12 shadow-2xl border-4 border-green-600 mb-8">
          ...
          {/* Badge Exclusivo - NOVO */}
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-full font-bold shadow-lg">
              <Shield className="w-5 h-5" />
              Acesso Completo - Investimento Único
            </div>
          </div>
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-center gap-3">
              ...
              <span>GARANTIR MEU ACESSO VITALÍCIO AGORA</span>
              <ArrowRight className="w-8 h-8" />
            </div>
          </button>

          {/* Microcopy abaixo do CTA - OTIMIZADO */}
          <div className="text-center mb-6">
            <p className="text-sm text-gray-600 mb-3">
              ✓ Acesso liberado após validação do CRM (6h) • ✓ Sem mensalidades • ✓ Garantia 30 dias
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-3">
              <p className="text-xs text-gray-700">
                <strong className="text-blue-600">Exclusivo para médicos registrados no CRM</strong> -
                Validação automática em até 6 horas
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 max-w-lg w-full relative max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-blue-600 font-semibold">
                CRM necessário • Plataforma exclusiva para médicos
              </p>
            </div>
