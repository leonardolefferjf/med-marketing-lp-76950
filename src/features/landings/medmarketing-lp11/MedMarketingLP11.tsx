...
const medMarketingLP11Config: LandingPageConfig = {
  id: 'medmarketing-lp11',
  title: 'MedMarketingAI+ LP11 - IA para Marketing Médico',
  description: 'Plataforma completa de inteligência artificial para marketing médico - 165 assistentes + 12 módulos',
  slug: 'medmarketing-lp11',
...
export const MedMarketingLP11: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP11Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP11;
