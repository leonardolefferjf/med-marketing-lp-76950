...
import { TrendingDown, TrendingUp, Clock, DollarSign, FileText, BarChart3, Activity, Users, Shield, AlertTriangle, Check, Sparkles, ArrowRight, Star, Play, Calendar, X } from 'lucide-react';
export default function BeforeAfterSection() {
  ...
  return <section className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white py-16 md:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            return <div key={idx} className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 md:p-6 hover:bg-gray-800 transition-all border border-gray-700 hover:border-gray-600">
        ...
        <div className="mb-16">
          ...
          {/* Selector de casos - placeholder, não usado nesta versão */}
        ...
        <div ref={sectionRef} className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-black rounded-2xl p-6 md:p-12 shadow-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8">
            ...
            return <div key={idx} className="bg-white rounded-xl p-5 md:p-6 text-center shadow-xl hover:scale-105 transition-transform">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 md:p-12 border-2 border-yellow-500">
            ...
            <button onClick={scrollToOffer} className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-black text-lg md:text-xl px-10 md:px-16 py-5 md:py-6 rounded-xl transition-all duration-200 shadow-2xl hover:scale-105">
