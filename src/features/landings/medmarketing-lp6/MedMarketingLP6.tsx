...
const medMarketingLP6Config: LandingPageConfig = {
  id: 'medmarketing-lp6',
  title: 'MedMarketingAI+ LP6 - IA para Marketing Médico',
  description: 'Plataforma completa de inteligência artificial para marketing médico - 165 assistentes + 12 módulos',
  slug: 'medmarketing-lp6',
...
export const MedMarketingLP6: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP6Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP6;
