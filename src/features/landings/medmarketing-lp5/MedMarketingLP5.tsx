...
const medMarketingLP5Config: LandingPageConfig = {
  id: 'medmarketing-lp5',
  title: 'MedMarketingAI+ LP5 - IA para Marketing Médico',
  description: 'Plataforma completa de inteligência artificial para marketing médico - 165 assistentes + 12 módulos',
  slug: 'medmarketing-lp5',
...
export const MedMarketingLP5: React.FC = () => {
  return (
    <LandingLayout config={medMarketingLP5Config}>
      <HeroSection />
      <ProblemsSection />
      <SolutionSection />
...
export default MedMarketingLP5;
