...
export default function FAQSection() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Não. Se você sabe usar WhatsApp, sabe usar o MedMarketingAI+. Os 162 assistentes já vêm prontos para uso. Basta escolher o assistente, digitar o que precisa e receber o conteúdo pronto em 30 segundos.'
    },
    {
      id: 'cfm-compliance',
      question: 'O conteúdo gerado está 100% dentro das normas do CFM?',
      answer: 'Sim. Todos os 162 assistentes foram treinados com base na resolução CFM 2.336/2023 e passam por validação automática antes de você publicar. Zero risco de infringir regras éticas.'
    },
    {
      id: 'apenas-medicos',
    ...
    },
    {
      ...
      answer: 'Sim. Você pode pagar à vista (R$ 997) ou parcelar em até 12x de R$ 103,00 no cartão de crédito.'
    },
    {
      id: 'garantia',
