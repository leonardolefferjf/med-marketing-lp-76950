      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Além dos 162 assistentes de IA, você recebe estes 3 bônus{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-red-900/20 border-2 border-red-500/50 rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                <div>• Fica travado se tiver dúvidas (sem tutor IA 24/7)</div>
                <div>• Perde tempo criando prompts do zero</div>
                <div>• Não tem comunidade para trocar ideias</div>
                <div>• Demora mais para dominar a ferramenta</div>
                <div className="pt-3 border-t border-red-500/30">
                  <strong className="text-red-400">Prejuízo: R$ 1.891</strong>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-900/20 border-2 border-green-500/50 rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                <div>✓ Tutor IA responde qualquer dúvida em segundos</div>
                <div>✓ Prompts prontos para usar em qualquer IA</div>
                <div>✓ Networking com 1.247 médicos de sucesso</div>
                <div>✓ Domina tudo 3x mais rápido</div>
                <div className="pt-3 border-t border-green-500/30">
                  <strong className="text-green-400">Ganho: R$ 1.891 GRÁTIS</strong>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-2xl p-6 md:p-8 shadow-2xl border-4 border-yellow-500 hover:scale-105 transition-transform relative">
            ...
            <div className="mb-6 relative group">
              <div className="w-full h-48 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl shadow-lg flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute bottom-4 left-0 right-0 text-center">
                  <div className="text-white font-black text-2xl">1.247+</div>
                  <div className="text-white/80 text-sm">Médicos Ativos</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300 text-sm">
                  Compartilhe <strong className="text-white">estratégias e cases</strong> reais
                </span>
              </div>
              ...
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300 text-sm">
                  Lives, <strong className="text-white">atualizações CFM</strong> e novos assistentes
                </span>
              </div>
            </div>
        ...
        <div className="bg-gray-800 rounded-2xl p-6 md:p-10 mb-10 border-2 border-gray-700">
          ...
          <div className="space-y-4 max-w-2xl mx-auto mb-6">
            <div className="flex items-center justify-between bg-gray-900 rounded-lg p-4">
              <span className="text-gray-300">MedMarketingAI+ (162 Assistentes)</span>
